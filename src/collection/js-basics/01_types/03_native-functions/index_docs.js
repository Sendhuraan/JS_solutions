(function() {
	...
	describe('Native Functions', function() {
		...
		it('Native funtions can be called with new operator in front of it or can be called as regular functions.');
		...
		describe('Call Natives as Constructors', function() {
			...
			it('There are some caveats in calling as constructors, as it constructs object around primitives.');
	...
	describe('Array', function() {
		...
		it('Array can be created by constructor form or literal syntax.');
		...
		describe('Constructor Syntax', function() {
			...
			it('Hence, it is better to avoid constructor syntax due to these caveats.');
		...
		describe('Literal Syntax', function() {
			...
			it('It is always preferable to use the literal syntax. It reads clearly and communicates our intent in a better way.');
	...
	describe('Object', function() {
		...
		describe('Constructor Syntax', function() {
			...
			it('Hence, it is better to avoid constructor syntax, as it is less performant.');
		...
		describe('Literal Syntax', function() {
			...
			it('It is always preferable to use the literal syntax. It reads clearly, communicates our intent in a better way and more performant.');
	...
	describe('RegExp', function() {
		...
		it('Regular Expression can be created by constructor form or literal syntax.');
	...
	describe('Date', function() {
		...
		it('Date object can be created only by constructor form.');

	});

	describe('Function', function() {
		
		it('Functions can be created by constructor form or literal syntax (as statement or expression).');
