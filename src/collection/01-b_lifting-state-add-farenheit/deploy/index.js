...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/collection/01-b_lifting-state-add-farenheit/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/collection/01-b_lifting-state-add-farenheit/index.js":
/*!******************************************************************!*\
  !*** ./src/collection/01-b_lifting-state-add-farenheit/index.js ***!
  \******************************************************************/
...
eval("(async function () {\n  var path = __webpack_require__(/*! path */ \"path\");\n\n  const Server = __webpack_require__(/*! ./server/server.js */ \"./src/collection/01-b_lifting-state-add-farenheit/server/server.js\");\n\n  const PORT = 3000;\n  const SERVE_DIR = 'client';\n  const CONTENT_DIR = path.join(__dirname, SERVE_DIR);\n  const server = new Server();\n  await server.start(CONTENT_DIR, PORT);\n  console.log(`Server Running at localhost:${PORT}`);\n})();\n\n//# sourceURL=webpack:///./src/collection/01-b_lifting-state-add-farenheit/index.js?");

/***/ }),

/***/ "./src/collection/01-b_lifting-state-add-farenheit/server/http-server.js":
/*!*******************************************************************************!*\
  !*** ./src/collection/01-b_lifting-state-add-farenheit/server/http-server.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
eval("(function () {\n  const HttpServer = __webpack_require__(/*! ./http-server.js */ \"./src/collection/01-b_lifting-state-add-farenheit/server/http-server.js\");\n\n  module.exports = class Server {\n    async start(contentDir, portNumber) {\n      if (!portNumber) throw new Error('port number is required');\n      this._httpServer = new HttpServer(contentDir);\n      await this._httpServer.start(portNumber);\n    }\n\n  };\n})();\n\n//# sourceURL=webpack:///./src/collection/01-b_lifting-state-add-farenheit/server/server.js?");
